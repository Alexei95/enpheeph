...
class LowLevelTorchMaskPluginABC(abc.ABC):
    @abc.abstractmethod
    def to_torch(self, array: enpheeph.utils.typings.LowLevelMaskArrayType) -> torch.Tensor:
        pass

    @abc.abstractmethod
    def from_torch(self, tensor: torch.Tensor) -> enpheeph.utils.typings.LowLevelMaskArrayType:
        pass
