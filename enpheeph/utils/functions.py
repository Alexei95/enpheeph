...
def current_utctime_string(template=enpheeph.utils.common.DEFAULT_TIME_FORMAT):
...
def time_string(datetime_obj, template=enpheeph.utils.common.DEFAULT_TIME_FORMAT):
...
def enable_determinism(seed=enpheeph.utils.common.DEFAULT_PRNG_SEED):
