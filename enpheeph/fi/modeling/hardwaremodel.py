...
class Kernel(object):
    ...
    # init
    kernel_type: enpheeph.fi.modeling.nnmodelsummary.MainLayerFunctionEnum
    ...
    raw_layer_info: typing.Optional[enpheeph.fi.modeling.nnmodelsummary.LayerInfo] = None
    ...
    def __post_init__(self):
        ...
        if self.kernel_type is enpheeph.fi.modeling.nnmodelsummary.MainLayerFunctionEnum.Conv2d:
            pass
        pass
...
class HardwareModel(object):
    ...
    def schedule_model_inference_run(
            self,
            model_summary: enpheeph.fi.modeling.nnmodelsummary.NNModelSummary,
