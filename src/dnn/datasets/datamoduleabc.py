...
class DataModuleABC(pl.LightningDataModule):
    ...
    # the following two abstract methods are based on the DataModule class
    ...
    # this method is used to reset the current indices used in the dataset
    # afterwards, setup must be run again to generate the new dataloaders
    # it is generally run again by PyTorch Lightning
    @abc.abstractmethod
    def reset_indices(self, *args, **kwargs):
        pass
