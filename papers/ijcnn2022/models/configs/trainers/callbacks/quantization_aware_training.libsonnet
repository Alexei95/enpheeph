...
trainer_config + {
    "trainer"+: {
        "callbacks" +: [
            {
                "class_path": "pytorch_lightning.callbacks.QuantizationAwareTraining",
                "init_args": {
                    ...
                    # as shown in diagram to find which layer types can be fused, check
                    ...
                    # (str) – allows switching between MovingAverageMinMaxObserver as “average”
