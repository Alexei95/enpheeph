...
DEFAULT_RESULT_DIRECTORY = "results/inference_image_classifier_vgg11_cifar10"
...
DEFAULT_MODEL_CHECKPOINT = (
    "results/sparse_results_ijcnn2023/trained_networks/vgg11_cifar10/"
    "epoch=29-step=19980.ckpt"
)
