...
def config(
    ...
    **kwargs: typing.Any,
    ...
    full_dataset_directory = pathlib.Path(dataset_directory) / "FasionMNIST"
    # we create the two datasets with the data
    train_dataset = torchvision.datasets.FasionMNIST(
    ...
    trainer = flash.Trainer(
        ...
        default_root_dir="results/image_classifier_resnet18_fashionmnist",
        ...
        logger=[
            pytorch_lightning.loggers.TensorBoardLogger(
                ...
                name="default",
                prefix="",
                save_dir="results/image_classifier_resnet18_fashionmnist",
                version=None,
            ),
        ],
        max_epochs=-1,
